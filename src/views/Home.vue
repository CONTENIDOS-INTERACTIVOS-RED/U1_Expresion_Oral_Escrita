        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad  aborda la comunicación asertiva en la educación infantil, destacando su importancia en la enseñanza, la interacción con estudiantes y la comunidad educativa. Se analizan sus características, estrategias para hablar en público, técnicas grupales y exposición académica. Se enfatiza la claridad en el mensaje, la escucha activa y la adaptación del lenguaje a la edad infantil. También se proponen dinámicas como el teatro de emociones y la rueda de soluciones para fortalecer habilidades comunicativas, mejorar la interacción y reducir conflictos en el aula, fomentando un ambiente de aprendizaje positivo y participativo.
